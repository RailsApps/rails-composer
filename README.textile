...
| "learn-rails":https://github.io/RailsApps/learn-rails | "Learn Ruby on Rails":http://learn-rails.com/learn-ruby-on-rails.html | book and example app for beginners |
| "rails-bootstrap":https://github.io/RailsApps/rails-bootstrap/ | "Tutorial":https://tutorials.railsapps.org/rails-bootstrap | Bootstrap front-end framework |
| "rails-foundation":https://github.io/RailsApps/rails-foundation/ | see "Learn Ruby on Rails":http://learn-rails.com/learn-ruby-on-rails.html | Foundation front-end framework |
| "Devise and Rails":https://github.io/RailsApps/rails-bootstrap/ | no tutorial (yet) | authentication |
