...
| "learn-rails":https://github.io/RailsApps/learn-rails | "Learn Ruby on Rails":http://learn-rails.com/learn-ruby-on-rails.html | book for beginners |
| "rails-foundation":https://github.io/RailsApps/rails-foundation/ | "Learn Ruby on Rails":http://learn-rails.com/learn-ruby-on-rails.html | Foundation front-end framework |
| "rails-bootstrap":https://github.io/RailsApps/rails-bootstrap/ | "Rails and Bootstrap Tutorial":https://tutorials.railsapps.org/rails-bootstrap | Bootstrap front-end framework |
| "rails-devise":https://github.io/RailsApps/rails-devise/ | no tutorial (yet) | authentication with Devise |
