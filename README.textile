...
Here are some of the starter apps you can build for Rails 4.0.
...
question  Use file for environment variables?
      1)  None
      2)  Use application.yml with Figaro
      3)  Use .env with Foreman
