...
If you're new to Rails, see "What is Ruby? And Rails?":http://railsapps.github.com/what-is-ruby-rails.html,  recommendations for a "Rails tutorial":https://tutorials.railsapps.org/rails-tutorial, and a list of top resources for "Ruby and Rails":http://railsapps.github.com/ruby-and-rails.html.
...
I recommend using "rvm":https://rvm.io/, the Ruby Version Manager, to manage your Rails versions, as described in the "Installing Rails":http://railsapps.github.com/installing-rails.html article.
...
When we create the gemset, the option "--rvmrc" creates an *.rvmrc* file in the root directory. RVM recognizes an *.rvmrc* file in an application's root directory and loads the required version of Ruby and the correct gemset whenever you enter the directory.
