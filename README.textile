...
It's the Rails generator on steroids. See the "Rails Composer project page":http://railsapps.github.com/rails-composer.
...
If you’re new to Rails, see recommendations for a "Rails tutorial":https://tutorials.railsapps.org/rails-tutorial and resources for getting started with "Rails":http://railsapps.github.com/rails.html.
...
If you choose one of the RailsApps example applications, you will get fewer choices but you will get an exact copy of a known working example application. See "Rails example applications":http://railsapps.github.com/ for more information.
...
|_. Getting Started |_. Articles |_. Example Application |_. Tutorial |
| Recommendations for a "Rails Tutorial":https://tutorials.railsapps.org/rails-tutorial | "title":link | "rails3-bootstrap-devise-cancan":https://github.com/RailsApps/rails3-bootstrap-devise-cancan | "Devise with CanCan and Twitter Bootstrap":https://tutorials.railsapps.org/rails3-bootstrap-devise-cancan |
| Resouces for "Rails":http://railsapps.github.com/rails.html | "title":link | "rails-stripe-membership-saas":http://railsapps.github.com/rails-stripe-membership-saas/ | "Rails Membership Site with Stripe":https://tutorials.railsapps.org/rails-stripe-membership-saas |
| "Installing Rails":http://railsapps.github.com/installing-rails.html | "title":link | "rails-recurly-subscription-saas":http://railsapps.github.com/rails-recurly-subscription-saas/ | "Rails Subscription Site with Recurly":https://tutorials.railsapps.org/rails-recurly-subscription-saas |
| "Updating Rails":http://railsapps.github.com/updating-rails.html | "title":link | "rails-prelaunch-signup":http://railsapps.github.com/rails-prelaunch-signup/ | "Startup Prelaunch Signup Application":http://railsapps.github.com/tutorial-rails-prelaunch-signup.html |
| | "title":link | "rails3-devise-rspec-cucumber":https://github.com/RailsApps/rails3-devise-rspec-cucumber | "Devise with RSpec and Cucumber":http://railsapps.github.com/tutorial-rails-devise-rspec-cucumber.html |
| | "title":link | "rails3-mongoid-devise":https://github.com/RailsApps/rails3-mongoid-devise | "Devise with Mongoid":http://railsapps.github.com/tutorial-rails-mongoid-devise.html |
| | "title":link | "rails3-mongoid-omniauth":https://github.com/RailsApps/rails3-mongoid-omniauth | "OmniAuth with Mongoid":http://railsapps.github.com/tutorial-rails-mongoid-omniauth.html |
| | "title":link | "rails3-subdomains":https://github.com/RailsApps/rails3-subdomains | "Subdomains with Devise":http://railsapps.github.com/tutorial-rails-subdomains.html |
