...
You can purchase the "Capstone Rails Tutorials":https://tutorials.railsapps.org/ to support the project. The tutorials explain all the code in the starter applications. "Sign up for the Rails Composer mailing list":http://mailinglist.railscomposer.com/ for news and announcements.
...
| "rails-mailinglist-activejob":https://github.com/RailsApps/rails-mailinglist-activejob | "Mailing List with Active Job Tutorial":http://railsapps.github.io/rails-mailinglist-activejob/ | sign up for a mailing list using background processing |
